...
The \gls{gNB} is further divided into three main functional units: 
\begin{description}
...
\begin{description}
  ...
  The Xn interface connects a \glspl{gNB} between each other, enabling inter-cell coordination and handover management. This cell also supports dual connectivity scenarios, where a \gls{UE} can be simultaneously connected to multiple \glspl{gNB} for improved performance and reliability. 
