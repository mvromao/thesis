...
\begin{description}{}
    \item{\textbf{Chapter 2}} This chapter details extensively the fundamental elements and architecture of 5G networks, going into detail about both the \gls{RAN} and Core components, along with their features, as well as current open-source solutions for implementing the architecture. An overview of the existing testbeds and experimental projects in the field of 5G networks is also provided. 
    \item{\textbf{Chapter 3}} This chapter describes the work plan and the milestones to reach along the thesis project.
    \item{\textbf{Chapter 4}} This chapter concludes the document, summarizing the key points and outlining the next steps for the thesis project.
\end{description}
\clearpage