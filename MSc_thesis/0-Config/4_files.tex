...
\ntaddfile{chapter}{1 - Introduction}
\ntaddfile{chapter}{2 - Fundamentals of a 5G Network}
\ntaddfile{chapter}{3 - State of the Art}
\ntaddfile{chapter}{4 - Proposed Architecture}
\ntaddfile{chapter}{5 - Methodology}
\ntaddfile{chapter}{6 - Results}
\ntaddfile{chapter}{7 - Conclusions}
...
\ntaddfile{appendix}{provisioning_esim}  % Chapter about provisioning the esim and connecting to the network
