...
\begin{itemize}
    ...
    \item A documented account of how specific configuration issues were diagnosed and corrected across successive test rounds, intended as a practical reference for others deploying a similar open-source stack.
\end{itemize}
