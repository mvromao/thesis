...
\begin{itemize}
    ...
    \item Chapter~\ref{cha:proposed-architecture} presents the architecture deployed for the testbed: the hardware components, the core network design, the \gls{RAN} design, and the interfaces connecting them.
    ...
    \item Chapter~\ref{cha:conclusions} (\textcolor{red}{Conclusions}) concludes the dissertation, summarising the main findings, their limitations, and the work left open for the future.
\end{itemize}