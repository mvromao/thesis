...
This chapter revolves around the proposed architecture for implementing the 5G network, using free open-source software and \gls{SDR} hardware. The remainder of this chapter is structured as follows: Section 4.1 details the physical hardware assets, including the processing servers, software-defined radios, clock synchronization equipment, and user equipment. Section 4.2 describes the architectural implementation of the 5G Core Network, while Section 4.3 outlines the structure of the Radio Access Network. Finally, Section 4.4 illustrates the comprehensive system topology and the standardized interfaces bridging the entire environment, providing a logical transition into the physical implementation detailed in Chapter 5.
...
For the radio, two \glspl{SDR} were used:
\begin{itemize}
