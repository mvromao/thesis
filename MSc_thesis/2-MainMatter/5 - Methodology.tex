...
\begin{figure}[htbp]
    ...
    \caption{Slot and symbol structure of the 3:1 \gls{TDD} pattern used in Round 1.}
...
\begin{figure}[htbp]
    ...
    \caption{Slot and symbol structure of the rebalanced 5-slot period of the 2:2 \gls{TDD} pattern used from Round 2 onward.}
