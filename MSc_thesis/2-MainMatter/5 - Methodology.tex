...
\begin{table}[htbp]
    ...
    \begin{tabular}{|c|c|c|c|c|c|c|c|}
        ...
        \hline
    \end{tabular}
    \caption{Summary of the 5G network configuration and data validity across the three test rounds. Round 1 covers both generations; Rounds 2 and 3 cover the 5G network only, as the 4G network was not re-tested.}
