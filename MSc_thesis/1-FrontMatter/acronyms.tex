...
\newacronym{5GC}{5GC}{5G Core} %CHANGED BY CLAUDE
...
\newacronym{RSRP}{RSRP}{Reference Signal Received Power} %CHANGED BY CLAUDE
...
\newacronym{EPS}{EPS}{Evolved Packet System} %CHANGED BY CLAUDE
...
\newacronym{USRP}{USRP}{Universal Software Radio Peripheral} %CHANGED BY CLAUDE
\newacronym{UHD}{UHD}{USRP Hardware Driver} %CHANGED BY CLAUDE
